...
import { ExternalLink, Github, CheckCircle, Eye } from 'lucide-react';
import { profileData } from '../mock';

const Projects = () => {
  const [filter, setFilter] = useState('All');
  
  const categories = ['All', 'Design', 'Web Development', 'React Applications', 'AI/No-Code', 'Full-Stack/AI'];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            A showcase of my journey through design, development, and innovation - from UI/UX concepts to full-stack applications
          </p>
        </div>
              ...
              >
                ...
                <div className="relative overflow-hidden h-48 bg-slate-100">
                  ...
                  <div className="absolute top-3 right-3">
                    <Badge className="bg-green-100 text-green-600 flex items-center gap-1 text-xs">
                  ...
                  <div className="absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <Button
                      size="sm"
                      className="bg-white/90 text-slate-800 hover:bg-white text-xs"
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    <CardTitle className="text-lg font-semibold text-slate-800 group-hover:text-blue-600 transition-colors leading-tight">
                      {project.title}
                    </CardTitle>
                    <Badge variant="outline" className="text-xs border-blue-200 text-blue-600 ml-2 flex-shrink-0">
                      {project.category}
                    </Badge>
                  </div>
                </CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        // For projects with GitHub repos, we could add GitHub links
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          ...
          <div>
            ...
            <div className="text-sm text-slate-600">Technology Stacks</div>
          </div>
          <div>
            <div className="text-3xl font-bold text-blue-600">100%</div>
            <div className="text-sm text-slate-600">Live & Accessible</div>
          </div>
          <div>
            <div className="text-3xl font-bold text-blue-600">3</div>
            <div className="text-sm text-slate-600">AI-Powered Projects</div>
          </div>
        </div>
